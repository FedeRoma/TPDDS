namespace TP_DDS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TP_DDS.DAL.TPDDSContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "TP_DDS.DAL.TPDDSContext";
        }

        protected override void Seed(TP_DDS.DAL.TPDDSContext context)
        {
